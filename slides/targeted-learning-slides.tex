...
\begin{frame}[label={sec:org25aa18d}]{Nuisance and target parameters}
...
\end{frame}
\begin{frame}[label={sec:orga0b5d26},fragile]{Example with \texttt{R}-code (G-formula)}
...
\begin{frame}[label={sec:orgbef2d0f}]{Low and high-dimensional nuisance parameter}
...
\begin{frame}[label={sec:org9adc7de}]{The challenge with high-dimensional nuisance parameters}
...
\begin{frame}[label={sec:orgd530598}]{Asymptotic linear estimators}
\small
...
\begin{frame}[label={sec:orgd6e3e0d}]{Illustration of the effect of debiasing}
...
\begin{frame}[label={sec:orgd4dd190}]{For the rest of the project}
...
\begin{frame}[label={sec:orgc5e4b54}]{References}
