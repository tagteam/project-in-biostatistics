...
\begin{frame}[label={sec:orge12ba4a}]{Result of simulation study}
\begin{center}
\includegraphics[width=.9\linewidth]{naive-vs-targeted.pdf}
\end{center}
\end{frame}

\begin{frame}[label={sec:org91e4ec4},fragile]{Statistical inference}
...
\begin{frame}[label={sec:org3675e11}]{References}
